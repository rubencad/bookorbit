...
- **Komga-Compatible API**: Comic apps built for Komga, including Mihon and the Tachiyomi forks, Suwayomi, Komelia, and Paperback, browse your libraries, stream comic pages, and sync read progress both ways through dedicated Komga accounts. See the [Komga API guide](docs/KOMGA_API.md).
